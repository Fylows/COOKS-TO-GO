...
const ORDER_START_LIFETIME_SECONDS: float = 30.0
const ORDER_MIN_LIFETIME_SECONDS: float = 15.0
const ORDER_LIFETIME_DECREASE: float = 1.0
const ORDER_LIFETIME_DECREASE_INTERVAL: int = 5
